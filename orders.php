...
<div id="work-collections" class="seaction">
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$sql2 = mysqli_query($con, "SELECT * FROM order_items WHERE id = $item_id;");
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2020 <a class="grey-text text-lighten-4" href="#" target="_blank">TEAM AAS</a>FOR JAYAKUMAR K.</span>
