      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Comments</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
								if(!isset($_GET['status'])){
									...
									"><a href="tickets.php">All Comments</a>
                                </li>
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM comments WHERE poster_id = $user_id AND not deleted;");
									while($row = mysqli_fetch_array($sql)){
									if(isset($_GET['status'])){
										$status = $row['status'];
									}
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Comments</h5>
              </div>
            </div>
          </div>
        </div>
...
<div>
        ...
        <div class="container">
          ...
          <div class="divider"></div>
								...
								<?php
									...
									$sql = mysqli_query($con, "SELECT * FROM comments WHERE poster_id = $user_id AND status LIKE '$status' AND not deleted;");
									while($row = mysqli_fetch_array($sql)){								                                
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2020 <a class="grey-text text-lighten-4" href="#" target="_blank">Students</a> TEAM AAS.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">TEAM AAS FOR PROFF JAYAKUMAR K</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
