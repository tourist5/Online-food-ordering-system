...
{
		$ticket_id = $_GET['id'];
		$sql1 = "SELECT * FROM comments where poster_id = $user_id AND id = $ticket_id AND not deleted;";
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Comments</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="tickets.php">All Comments</a>
                                </li>
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM comments WHERE poster_id = $user_id;");
									while($row = mysqli_fetch_array($sql)){
...
<div class="section">
								...
								$sql1 = mysqli_query($con, "SELECT * from comment_details WHERE ticket_id = $ticket_id;");
